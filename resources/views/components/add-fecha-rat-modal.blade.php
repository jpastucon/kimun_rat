...
<div id="{{ $name }}" x-data="{ show: false }" x-show="show" style="display:block">
    ...
    <div class="main-modal fixed px-2 py-2 w-full inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
        ...
        <div
            class="border border-gray-500 w-full h-3/4 md:w-auto md:h-3/4 sm:h-1/2 modal-container bg-white rounded shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="flex justify-end mt-2 pt-2">
                    {{ $footer }}
                    <p></p>
                    <button onclick="cerrarModalFechaAdd()"
...
<script>
    function cerrarModalFechaAdd() {
        if ($("#modalFechaAdd").parent().is(":visible")) {
            $("#modalFechaAdd").parent().toggle();
        }
    }
</script>