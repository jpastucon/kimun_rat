<!-- component -->
<div id="{{ $name }}" class="z-0">
    <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
        <div class="relative">
            <input type="hidden" name="date" x-ref="date" :value="{{ $name }}" />
            <input type="text" x-on:click="showDatepicker = !showDatepicker" x-model="{{ $name }}"
        ...
        function app() {
            return {
                ...
                initDate() {
                    ...
                    this.{{ $name }} = this.formatDateForDisplay(
                        today
                    );
                },
